...
public class Fireworks extends EntityFireworks {
	Player[] players = null;

	public Fireworks(World world, Player... p) {
		super(world);
		players = p;
		this.a(0.25F, 0.25F);
	}
	...
	public static void spawn(Location location, FireworkEffect effect, Player... players) {
		try {
			Fireworks firework = new Fireworks(((CraftWorld) location.getWorld()).getHandle(), players);
